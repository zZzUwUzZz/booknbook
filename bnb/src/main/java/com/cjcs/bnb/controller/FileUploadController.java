...
public class FileUploadController {
    ...
    @ResponseBody
    public ResponseEntity<String> upload(@RequestParam("file") MultipartFile file, HttpSession session, Model model) {
        String sellerId = (String) session.getAttribute("loggedInUser");
        if (sellerId == null) {

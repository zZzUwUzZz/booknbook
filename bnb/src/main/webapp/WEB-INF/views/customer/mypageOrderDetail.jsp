...
<body>
                            ...
                            <div class="items">
                                <article class="opItemBox">
                                    <div class="opItem">
                                        <div class="opimg">
                                            <img
                                                src="https://contents.kyobobook.co.kr/sih/fit-in/150x0/pdt/${rentISBN}.jpg">
                                        </div>
                                        <div class="opItemInfoText">
            ...
            <div class="totalInfoBox">
                ...
                <div class="infobox">
                    ...
                    <div class="infotext">
                        <span>총 상품금액 </span>
                        <span>
                            <fmt:formatNumber value="${oInfo.o_total_pricerent}" type="number" pattern="#,##0" /> 원
                        </span>
                    </div>
                    ...
                    <div class="infotext">
                        <span>총 배송비 </span>
                        <span>
                            <fmt:formatNumber value="${oInfo.o_total_deliveryfee}" type="number" pattern="#,##0" /> 원
                        </span>
                    </div>
                    ...
                    <div class="infotext">
                        <span>총 결제금액 </span>
                        <span>
                            <fmt:formatNumber value="${oInfo.o_total_payment}" type="number" pattern="#,##0" /> 원
                        </span>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(() => {
            ...
            for (let oPItem of oPList) {
                
                let code = oPItem.delivery_status_id;
            ...
            for (let oRItem of oRList) {
                ...
                let code = oRItem.delivery_status_id;
                if (code == 4 || code == 6 || code == 7) {
                    $('#cancel-btn').attr('disabled', true);
                }
            }

    ...
    <div class="container-mypage">
        ...
        <div class="board-area">
                        ...
                        <div class="pListContain">
                            <article class="pItemBox">
                                ...
                                <div class="pTitle">
                                    <div class="pText">
                                        주문번호</div>
                                    <div onclick="location.href='/mypage/orderdetail/${pItem.o_id}'" class="td-linked">
                                        #${pItem.o_id}
                                    </div>
                                </div>
                                ...
                                <div class="pItem" title="${pItem.b_title}">
            ...
            <div class="btnbox01">
                ...
                <c:if test="${!empty pList}">
                    <div class="btnbox">
                        <button type="submit" id="submit" class="exbtn" disabled>교환/반품신청</button>
                    </div>
                </c:if>
            </div>

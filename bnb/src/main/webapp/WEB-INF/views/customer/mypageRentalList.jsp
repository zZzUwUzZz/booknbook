                                        ...
                                        <div class="rListBox">
                                            <article class="rItemBox">
                                                ...
                                                <div class="pTitle">
                                                    ...
                                                    <fmt:formatDate value="${rItem.o_date}" pattern="yyyy년 MM월 dd일" />
                                                ...
                                                <div class="pDeli">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${rItem.rental_status eq '연체'}">
                                                            <span
                                                                style="color: rgb(255, 60, 0);">${rItem.rental_status}</span>
                                                        </c:when>
                                                        <c:otherwise>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                ...
                                                <div class="pDeli">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${!empty rItem.r_duedate}">
                                                            <fmt:formatDate value="${rItem.r_duedate}"
                                                ...
                                                <div class="pRe">
                                                    ...
                                                    <c:choose>
                                                        <c:when
                                                            ...
                                                            <span title="연체료를 납부해주세요." style="color: rgb(255, 60, 0);">
                                                                <fmt:formatNumber value="${rItem.r_latefee_total}"
                                                                    type="number" pattern="#,##0" />원
                                                            </span>
                                                        </c:when>
                                                        <c:when test="${!empty rItem.r_latefee_total}">
                                                            <fmt:formatNumber value="${rItem.r_latefee_total}"
                                                                type="number" pattern="#,##0" />원</span>
                                                        </c:when>
                                                        <c:otherwise>
                                                            -
                                                        </c:otherwise>
                                                ...
                                                <div class="rtTitle01">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${!empty rItem.r_latefee_paydate}">
                                                            <fmt:formatDate value="${rItem.r_latefee_paydate}"
                                                                pattern="yyyy년 MM월 dd일" />
                                                        </c:when>
                                                        <c:otherwise>
                                                            -

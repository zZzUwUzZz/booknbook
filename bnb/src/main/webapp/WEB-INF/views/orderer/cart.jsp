							...
							<td>
								<table>
									<tr>
										<td>대여비</td>
										<td>
											<span class="totalPrice_span_second">3000</span> 원
										</td>
									</tr>
									<tr>
										<td>배송비</td>
										<td>
											<span class="delivery_price_second">3000</span>원
										</td>
									</tr>									
									<tr>
										<td>총 주문 상품 수</td>
										<td><span class="totalKind_span_second"></span> 총 <span class="totalCount_span"></span>권</td>
									</tr>
								</table>
							</td>
						</tr>
					</table>
					<div class="boundary_div_second">구분선</div>
					<table>
						<tr>
							<td>
								<table>
									<tbody>
										<tr>
											...
											<td>
												<span class="finalTotalPrice_span_second">70000</span> 원
											</td>
										</tr>
									</tbody>
								</table>
